...
######################################################
# How to use this
# Implement the needed code in othello_shell.py (constructor and get_valid_moves)
# save your file as "strategy.py" in this folder
# Your file gets imported below and the method get_valid_moves is called
#####################################################
...
def test_all():
    ...
    for i in cases:
        board, player, correct_moves = i
        #print(ref.get_pretty_board(board))
        my_moves = ref.get_valid_moves(board, player)
        print(sorted(my_moves), sorted(correct_moves))
        assert(set(my_moves) == set(correct_moves))
